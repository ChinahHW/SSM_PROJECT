...
<div class="page-container">
	<form  action="uploadMoviePicture" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="url" id="url" name="url">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="clazz" class="select">
...
<!-- <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container"> 
					<div style='border-left: 30%'>
											<form action="uploadMoviePicture" method="post" enctype="multipart/form-data">
												文件：<input id='file1' type="file" name="file" />
												<img id="img1" style="width:80px;height:80px;display: none">
												<input type="submit" value="上传" class="btn btn-primary radius"/>
											</form>
                                        </div>
				</div>
			</div>
