...
<div class="page-container">
	<form  action="doChangeInfo" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.age }" placeholder="年龄" id="age" name="age">
			</div>
		</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container"> 
					<div style='border-left: 30%'>
											...
											<img id="img1" style="width:80px;height:80px;" src='http://localhost:8080/images/${user.picture }'>
                                        </div>
				</div>
			</div>
		</div>
