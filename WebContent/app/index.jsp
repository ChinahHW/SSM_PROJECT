...
$(function(){
	...
	$.post(url,data,function(result){
		/* <li><img src="http://localhost:8080/images/r1.jpg" alt=""/></li> */
		for(var i=0;i<result.length;i++){
			str += "<li class='nbs-flexisel-item' style='width: 235px;'><a href='${pageContext.request.contextPath}/detail?id="+result[i].id+"'><img src='http://localhost:8080/images/"
					+result[i].picture+"' alt=''/></a></li>";
		}
	...
	<div class="full">
			<div class="menu">
				<ul>
					...
					<li><a href="video"><div class="video"><i class="videos"></i><i class="videos1"></i></div></a></li>
		...
		<div class="header">
			<div class="top-header">
				...
				<div class="search">
					...
					<form action="${pageContext.request.contextPath}/findMovie?p=1">
						<input type="text" id="condition" name="condition"/>
						<input type="submit" value="">
					</form>
				</div>
				<div style='position: absolute;left: 75%;top: 32px;'>
					<a href='${pageContext.request.contextPath}/getLogin'>登录</a>
					<a href='${pageContext.request.contextPath}/getLogin'>注册</a>
				</div>
			...
			<div class="header-info">
				...
				<a class="video" href="${pageContext.request.contextPath}/detail?id=6"><i class="video1"></i>WATCH TRAILER</a>
				<a class="book" onclick="collect(6)"><i class="book1"></i>Collect it</a>
			</div>
		</div>
