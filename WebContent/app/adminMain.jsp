...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/app/style/css/lib/Hui-iconfont/1.0.8/iconfont.css" />
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="${pageContext.request.contextPath }/userMain">前往首页</a></li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="movie-list" data-title="电影管理" href="javascript:void(0)">电影管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="member-changeInfo" data-title="修改信息" href="javascript:void(0)">修改信息</a></li>
					<li><a data-href="member-changePassword" data-title="修改密码" href="javascript:void(0)">修改密码</a></li>
			</ul>
		</dd>
	</dl>
</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${pageContext.request.contextPath }/app/style/js/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
</body>
</html>